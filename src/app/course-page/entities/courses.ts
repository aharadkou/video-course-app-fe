...
import { CourseImpl } from './course/impl/course-impl.model';

const mockDescription : string = `Learn about where you can find course descriptions, what information they include, how they work, 
